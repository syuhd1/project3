                            ...
                            <table class="table table-striped table-hover table_deg" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $order->address }}</td>
                                        <td>
                                            <form id="update-form-{{ $order->id }}" action="{{ url('staff/update_order', $order->id) }}" method="POST">
                                                @csrf
                                        ...
                                        <td class="boxbtn-vertical">
                                            ...
                                            <!-- <a class="btn btn-danger" onclick="confirmation(event)" href="{{ url('staff/delete_order', $order->id) }}">Delete</a> -->
                                            <!-- <a class="btn btn-secondary" href="{{url('staff/print_pdf', $order->id)}}">Print</a> -->
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
