                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="boxbtn-vertical">
                                            ...
                                            <!-- <a class="btn btn-danger" onclick="confirmation(event)" href="{{ url('delete_order', $quote->id) }}">Delete</a> -->
                                            <!-- <a class="btn btn-secondary" href="{{url('print_pdf', $quote->id)}}">Print</a> -->
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
